...
export const HeatmapLayer = (props) => {
    ...
    return (React.createElement(Source, { type: "geojson", data: props.data },
        clickbuffer && React.createElement(Layer, { id: `${props.id}-clickbuffer`, ...clickbuffer }),
        React.createElement(Layer, { id: `${props.id}-ht`, ...heatmap }),
        React.createElement(Layer, { id: `${props.id}-pt`, ...point })));
};
